...
// Component for selecting cards from the market when Ginger card is played
const GingerSelection = ({
  market,
  selectCount,
  expiresAt,
  onSubmit,
    ...
    <div className="borsht-decision-popup-overlay">
      <div className="borsht-decision-popup borsht-discard-popup">
        <div className="borsht-decision-popup-header">
          <div className="borsht-decision-popup-title">Ginger Effect</div>
          <div className="borsht-decision-popup-message">
            Select up to {selectCount} card{selectCount !== 1 ? 's' : ''} from the market to add to your hand
          </div>
        </div>
        ...
        <div className="borsht-discard-selection-cards">
          {marketCards && marketCards.length > 0 ? (
            ...
            <div className="borsht-empty-pot">Market is empty</div>
          )}
        </div>
...
export default GingerSelection;